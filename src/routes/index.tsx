...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      {
        title:
          "Rajputri Tours & Travels — Premium Taxi in Chidambaram, Tamil Nadu",
      },
      {
        name: "description",
        content:
          "Book premium Sedan taxi from Chidambaram: Chennai/Trichy airport transfers, temple tour packages, outstation, one-way & round trips. Safe, comfortable, on-time.",
      },
      {
        property: "og:title",
        content:
        ...
        <div className="glass rounded-2xl shadow-soft flex items-center justify-between gap-4 px-4 py-3">
          <a href="#home" className="flex items-center gap-2 min-w-0">
            ...
            <div className="min-w-0 leading-tight">
              <div className="font-display text-base font-bold text-royal truncate">
                Rajputri
              </div>
      ...
      <div className="relative mx-auto max-w-7xl px-4 flex flex-col justify-center min-h-[calc(100svh-11rem)]">
        <div className="max-w-2xl animate-fade-up">
          ...
          <h1 className="mt-5 text-white font-display text-4xl sm:text-5xl lg:text-6xl font-bold leading-[1.05]">
            Your Trusted{" "}
            <span className="text-gradient-gold">Travel Partner</span> in
            Tamil Nadu
          </h1>

          <p className="mt-5 text-base sm:text-lg text-white/85 max-w-xl">
            Safe · Comfortable · On-Time · Affordable Sedan taxi services for
            airport transfers, temple tours and outstation trips across South
            India.
          </p>
...
function Services() {
  const items = [
    {
      ...
      desc: "Chennai · Trichy · Pondicherry airports with meet & greet.",
    },
    {
      icon: Car,
      title: "Local Taxi",
      desc: "Hourly and full-day rentals within the city.",
    },
    {
      icon: RouteIcon,
      title: "Outstation Taxi",
      desc: "Comfortable long-distance rides across Tamil Nadu.",
    },
    {
      icon: Landmark,
      title: "Temple Packages",
      desc: "Curated pilgrimage tours with expert local drivers.",
    },
    {
      icon: Briefcase,
      title: "Corporate Travel",
      desc: "Reliable travel partner for meetings and events.",
    },
    {
      icon: Sparkles,
      title: "Wedding Travel",
      desc: "Elegant Sedan for the family on your special day.",
    },
    {
      icon: Train,
      title: "Railway Station Pickup",
      desc: "On-time arrivals at every major junction.",
    },
    {
      icon: Building2,
      title: "Hotel Transfers",
      desc: "Doorstep pickup from your hotel or resort.",
    },
  ];
  ...
  return (
    <SectionShell
      ...
      title="Premium services, priced honestly"
    >
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        {items.map(({ icon: Icon, title, desc }) => (
          ...
          >
            ...
            <h3 className="mt-5 font-display text-lg font-semibold text-royal">
              {title}
            </h3>
...
function PopularRoutes() {
  ...
  return (
    <SectionShell
      ...
      title="Popular routes from Chidambaram"
    >
        ...
        {routes.map(([to, km, price]) => (
          ...
          >
            ...
            <div className="mt-1 flex items-center gap-2">
              ...
              <div className="font-display text-lg font-semibold text-royal">
                {to}
              </div>
            </div>
      ...
      <div className="grid lg:grid-cols-2 gap-8 items-center">
        ...
        <div>
          <p className="text-muted-foreground leading-relaxed">
            “Travel with confidence. Our professional driver will be ready to
            assist you with a smooth and comfortable airport transfer. We value
            your time and ensure a reliable, hassle-free journey from pickup to
            destination.”
          </p>
          ...
          <div className="mt-6 grid sm:grid-cols-2 gap-3">
            {[
              ...
              <div key={n} className="glass rounded-2xl p-4 shadow-soft">
                ...
                <div className="text-lg font-bold mt-2">{p}</div>
              </div>
            ))}
          </div>
          ...
          <a
            href="#book"
            className="mt-6 inline-flex items-center gap-2 rounded-xl gradient-royal text-royal-foreground px-5 py-3 text-sm font-semibold shadow-elegant hover:opacity-95"
          >
...
function WhyUs() {
  const items = [
    ...
    [
      ...
      "Courteous, uniformed, English-speaking.",
    ],
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {items.map(([Icon, t, d]) => {
          ...
          return (
            <div
              key={t as string}
              className="rounded-2xl p-5 bg-card border border-border shadow-soft hover:shadow-elegant transition text-center"
            >
              <div className="mx-auto grid h-14 w-14 place-items-center rounded-2xl gradient-gold text-gold-foreground shadow-gold">
                <I className="h-6 w-6" />
              </div>

              <div className="mt-4 font-display font-semibold text-royal">
                {t as string}
              </div>
          ...
          >
            <div
              className={`text-xs uppercase tracking-widest font-semibold ${
                i === 1 ? "text-gold" : "text-muted-foreground"
              }`}
            >
              {t.label}
            </div>
            ...
            <div className="mt-3 flex items-end gap-1">
              ...
              <div
                className={`pb-1.5 text-sm ${
                  i === 1 ? "text-white/80" : "text-muted-foreground"
                }`}
              >
                {t.per}
              </div>
...
function Reviews() {
  const reviews = [
    {
      n: "Priya R.",
      t: "Chennai Airport Pickup",
      r: "Driver was punctual, car spotless. Made our early flight stress-free. Highly recommend Rajputri!",
    },
    {
      n: "Anand K.",
      t: "Rameswaram Temple Tour",
      r: "Comfortable Sedan for a 2-day pilgrimage. Driver knew every temple's timings. Excellent service.",
    },
    {
      n: "Meera & Family",
      t: "Kumbakonam Navagraha",
      r: "Beautiful experience. On-time, safe and very affordable. Will definitely book again.",
    },
    {
      n: "James (NRI)",
      t: "Chidambaram → Pondicherry",
      r: "Booked from abroad via WhatsApp. Professional, clean, exactly as promised.",
    },
    {
      n: "Karthik S.",
      t: "Corporate Travel",
      r: "Our go-to travel partner for client visits in Tamil Nadu. Always reliable.",
    },
    {
      n: "Lakshmi V.",
      t: "Wedding Travel",
      r: "Elegant car for our wedding. Family was very comfortable. Thank you Rajputri!",
    },
  ];
    ...
    >
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
        {reviews.map((r) => (
          <div
            key={r.n}
            className="rounded-2xl bg-card border border-border p-6 shadow-soft hover:shadow-elegant transition"
          >
...
function FAQ() {
  const faqs = [
    [
      ...
      "You can book instantly via the form above, WhatsApp us, or call our 24×7 line. Confirmation arrives within minutes.",
    ],
    [
      "What payment methods do you accept?",
      "Cash, UPI, all major cards, and bank transfer. No advance required for local trips.",
    ],
    [
      "Can I cancel my booking?",
      "Yes — free cancellation up to 2 hours before pickup. Airport trips: 4 hours prior.",
    ],
    [
      "Are your drivers verified?",
      "All drivers are background-verified, licensed, and trained for hospitality.",
    ],
    [
      "Do you provide outstation multi-day trips?",
      "Absolutely. We build custom itineraries across Tamil Nadu, Kerala, Karnataka, and Puducherry.",
    ],
    [
      "What if my flight is delayed?",
      "We track your flight in real-time and adjust the pickup automatically at no extra cost.",
    ],
  ];
        ...
        <div>
          <div className="space-y-4">
            <ContactRow
              ...
              title="Office"
              text="Chidambaram, Cuddalore District, Tamil Nadu, India"
            />
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            <a
              href={`tel:${PHONE}`}
              className="inline-flex items-center gap-2 rounded-xl gradient-royal text-royal-foreground px-5 py-3 text-sm font-semibold shadow-elegant"
            >
              <Phone className="h-4 w-4" />
              Call Now
            </a>
            ...
            <a
              href={`https://wa.me/${WHATSAPP}`}
              className="inline-flex items-center gap-2 rounded-xl gradient-gold text-gold-foreground px-5 py-3 text-sm font-semibold shadow-gold"
            >
            ...
            <a
              href={`mailto:${EMAIL}`}
              className="inline-flex items-center gap-2 rounded-xl bg-card border border-border px-5 py-3 text-sm font-semibold text-royal"
            >
    ...
    <footer className="mt-20 gradient-royal text-royal-foreground">
      <div className="mx-auto max-w-7xl px-4 py-14 grid md:grid-cols-4 gap-8">
        <div>
          ...
          <p className="mt-4 text-sm text-white/75 leading-relaxed">
            Premium Sedan taxi services from Chidambaram since 2015. Safe,
          ...
          <div className="mt-5 flex gap-3">
            {[Facebook, Instagram, Twitter, Youtube].map((Ic, i) => (
              <a
                key={i}
                href="#"
                className="grid h-9 w-9 place-items-center rounded-full glass-dark hover:bg-white/20 transition"
              >
        ...
        <FooterCol
          title="Quick Links"
          items={["Home", "About", "Services", "Packages", "Contact"]}
        />
      ...
      <div className="border-t border-white/10">
        <div className="mx-auto max-w-7xl px-4 py-5 flex flex-wrap items-center justify-between gap-3 text-xs text-white/70">
          <div>
            © {new Date().getFullYear()} Rajputri Tours & Travels. All rights
            reserved.
          </div>
    ...
    <section id={id} className={`py-20 ${tinted ? "bg-secondary/60" : ""}`}>
      <div className="mx-auto max-w-7xl px-4">
        <div className="max-w-2xl mb-10">
          <div className="text-xs uppercase tracking-[0.25em] font-semibold text-gold">
            {eyebrow}
          </div>

          <h2 className="mt-2 font-display text-3xl sm:text-4xl font-bold text-royal">
            {title}
          </h2>
        </div>
