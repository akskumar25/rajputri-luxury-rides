...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Safe, comfortable and affordable Sedan taxi services in Chidambaram — Airport pickup, Temple tour packages, Outstation trips and Local rides across Tamil Nadu." },
      { name: "author", content: "Rajputri Tours & Travels" },
      { property: "og:title", content: "Rajputri Tours & Travels — Premium Taxi in Tamil Nadu" },
